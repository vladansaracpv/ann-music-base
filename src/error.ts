...
export const ErrorCode: ErrorCodes = {
  ...
  EmptyConstructor:
    "Cannot create Note from nothing. Provide name | midi | frequency.",
  InvalidNoteProperty: "Note property provided is not valid.",
  InvalidName:
    "Note.name provided is not a valid shape: <letter><accidental?><octave?>.",
  InvalidMidi: "Note.midi provided is not valid. Must hold: 0 < midi < 128.",
  InvalidChroma:
    "Chroma number provided is not valid. Must hold: 0 <= chroma < 12.",
  InvalidFrequency:
    "Frequency provided is not valid. Must be positive number > 0.",

  // Interval
  InvalidIvlConstructor: "Cannot create Interval from given initial values.",
  InvalidIvlName:
    "Interval.name provided is not a valid shape: <number><quality> | <quality><number>.",
